...
#print the all labtops seprately

print("all_laptops name:")
...
#laptops[0]['types'][1]["prices"]


print(f"{laptops[0]['types'][0]['price']} is for the price of the Apple Macbook Pro 13 inch. \n \
{laptops[0]['types'][1]['price']} is the price of the Apple Macbook Pro 16 inch. \n \
{laptops [1]['types'][0]['price']} is  the price of the  Dell XPS 13 inch. \n \
{laptops [1]['types'][1]['price']} is  the price of the  Dell XPS 15 inch.\n \
Print out all possible computer price")
